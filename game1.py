...
class Stone:
    ...
    def draw(self):
        pyxel.blt(self.x, self.y, 0, 8, 0, 8, 8, pyxel.COLOR_BLACK)#石
...
class Item:
    ...
    def draw(self):
        pyxel.blt(self.x, self.y, 0, 32, 0, 8, 8, pyxel.COLOR_BLACK)#もも

class HeartItem(Item):
    def draw(self):
        pyxel.blt(self.x, self.y, 0, 40, 0, 8, 8, pyxel.COLOR_BLACK)#ハート
...
class App:
    ...
    def update_start_scene(self):
        if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT):
            ...
            start_btn_x = screen_width//2-35
            start_btn_y = screen_height//2+15
            start_btn_w = 50
            start_btn_h = 10

            manual_btn_x = screen_width//2-25
            manual_btn_y = screen_height//2-10
            manual_btn_w = 50
            manual_btn_h = 10
    ...
    def draw_start_scene(self):
        ...
        start_btn_x = screen_width//2-35
        start_btn_y = screen_height//2+15
        pyxel.text(start_btn_x, start_btn_y, "CLICK TO START!!", pyxel.COLOR_WHITE)
        
        manual_btn_x = screen_width//2-25
        manual_btn_y = screen_height//2-10
        pyxel.text(manual_btn_x, manual_btn_y, "あそびかた", pyxel.COLOR_RED, self.jp_font)
    ...
    def draw_manual_scene(self):
        ...
        pyxel.blt(15 , 31, 0, 8, 0, 8, 8, pyxel.COLOR_BLACK)#石
        pyxel.blt(15 , 46, 0, 32, 0, 8, 8, pyxel.COLOR_BLACK)#もも
        pyxel.blt(15 , 61, 0, 40, 0, 8, 8, pyxel.COLOR_BLACK)#ハート
    ...
    def draw_play_scene(self):
        ...
        pyxel.blt(self.player_x, self.player_y, 0, 16, 0, 16, 16, pyxel.COLOR_BLACK)#スライムくん
        ...
        for i in range(self.life):
            pyxel.blt(screen_width-12-10*i, 5, 0, 40, 0, 8, 8, pyxel.COLOR_BLACK) #ハート
